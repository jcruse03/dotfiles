...
files="bashrc bash_prompt bash_profile tmux.conf vimrc aliases config/i3/config Xdefaults Xresources scripts/i3cmds/ddspawn scripts/i3cmds/tmuxdd i3blocks.conf inputrc"    # list of files/folders to symlink in homedir
